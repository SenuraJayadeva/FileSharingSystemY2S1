					...
					<ul class="clearfix">
						...
						<li class="icons dropdown">
							<div class="user-img c-pointer position-relative"
								...
								<%-- <c:forEach  var = "adm" items="${adminDeatils}">
                                ...
                                <div class="table-responsive">
                                    <table class="table header-border table-hover verticle-middle">
                                        ...
                                        <%InterfaceServicesDataAdmin intersda =  new servicesDataAdmin(); 
                                            ArrayList<Customer> cusDetails = intersda.getCustomerList();
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col"><%=cus.getUserID()%></th>
                                                <th scope="col"><%=cus.getFirstName()%></th>
                                                <th scope="col"><%=cus.getLastName()%></th>
                                                <th scope="col"><%=cus.getEmail()%></th>
                                                <th scope="col"></th>
                                                                                      
                                            	<th scope="col"><a  style='color:black; font-weight:bold;' href='deleteUserAdmin?userID=<%=cus.getUserID()%>'><button class="btn mb-1 btn-outline-primary">Delete</buttton></a></th>
                                        ...
                                        <%-- <c:forEach  var = "cus" items="${customerDetails}">
                                            <tr>
                                               ...
                                               <td><input type="button" value="Delete" name="delete" onclick=""></td>
