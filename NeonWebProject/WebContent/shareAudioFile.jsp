							...
							<h3>Share File</h3>
							   ...
							   <%
								...
								<div class="compose-content mt-5">
									<form action="shareAudio" method="post" enctype='multipart/form-data'>
									
										<div class="form-group">
											<input type="hidden" name="shareAudio_sendUser"  value="<%=userName%>" class="form-control bg-transparent">
										</div>
										
										<div class="form-group">
											<input type="hidden" name="shareAudio_sendUserImagePath"  value="<%=path%>" class="form-control bg-transparent">
										</div>
										
										<div class="form-group">
											<input type="hidden" name="shareAudio_audioID" class="form-control bg-transparent"
												value="<%=audio.getAudioID()%>">
										</div>
										
										<div class="form-group">
											<input type="text" name="shareAudio_name" class="form-control bg-transparent"
												value="<%=audio.getName() %>" readonly>
										</div>
											
										<div class="form-group">
											<input type="text" name="shareAudio_description" class="form-control bg-transparent"
												value="<%=audio.getDescription() %>" readonly>
										</div>
										
										<div class="form-group">
											<input type="text" name="shareAudio_filename" class="form-control bg-transparent"
												value="<%=audio.getFilename() %>" readonly>
										</div>
										
										<div class="form-group">
											<input type="hidden" name="shareAudio_path" class="form-control bg-transparent"
												value="<%=audio.getPath() %>">
										</div>
										
										<div class="form-group">
											<input type="text" name="shareAudio_receivedUser" class="form-control bg-transparent"
