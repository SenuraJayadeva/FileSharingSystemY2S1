	...
	<div id="main-wrapper">
        ...
        ***********************************-->
         <div class="col-lg-10" >
                        <div class="card" >
                            <div class="card-body">
                               <form action="searchUserContentDeleteAdmin" method="POST" >
						<input type="search" class="form-control" id="searchEmail" name ="searchEmail"
							placeholder="Enter ID number" aria-label="Search Dashboard">
							<br>
                                    ...
                                    <table class="table header-border table-hover verticle-middle">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                            	...
                                            	<th scope="col"><a  style='color:black; font-weight:bold;' href='deletePhotos?photoID=<%=photo.getPhotoID() %>&userID=<%=photo.getUserID() %>&fileName=<%=photo.getFilename()%>'><button type="button" class="btn mb-1 btn-outline-primary">Delete</buttton></a></th>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                   ...
                                   <thead>
                                        ...
                                        <tbody>
                                            <%
                                            ArrayList<Document> docDetails = intersda.getDocumentlist(SearchUserID);
                                            
                                            
                                            int m = 1;
            								for(Document doc : docDetails){
                                            ...
                                            <tr>
                                            	...
                                            	<th scope="col"><a  style='color:black; font-weight:bold;' href='deleteDocument?docId=<%=doc.getDocId() %>&userID=<%=doc.getUserID() %>&fileName=<%=doc.getFilename()%>'><button type="button" class="btn mb-1 btn-outline-primary">Delete</buttton></a></th>
                                    ...
                                    <table class="table header-border table-hover verticle-middle">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col"><%=aud.getUserID() %></th>
                                            	<th scope="col"><a  style='color:black; font-weight:bold;' href='deleteAudio?audioID=<%=aud.getAudioID()%>&userID=<%=aud.getUserID()%>&fileName=<%=aud.getFilename()%>'><button type="button" class="btn mb-1 btn-outline-primary">Delete</buttton></a></th>
                                ...
                                <div class="table-responsive">
                                    <table class="table header-border table-hover verticle-middle">
                                       <thead>
                                        ...
                                        <tbody>
                                            <%
                                            ArrayList<Video> videoDetails = intersda.getVideoList(SearchUserID);
                                            
                                            
                                            int l = 1;
            								for(Video vid : videoDetails){
                                            ...
                                            <tr>
                                            	...
                                            	<th scope="col"><a  style='color:black; font-weight:bold;' href='deleteVideo?videoID=<%=vid.getVideoID() %>&userID=<%=vid.getUserID() %>&fileName=<%=vid.getFilename()%>'><button type="button" class="btn mb-1 btn-outline-primary">Delete</buttton></a></th>
