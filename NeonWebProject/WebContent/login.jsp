					...
					<ul class="clearfix">
						...
						<li class="icons dropdown d-none d-md-flex">
						     ...
						     <a href="javascript:void(0)" class="log-user"  data-toggle="dropdown">
                                <i
								class="fa fa-user f-s-14" aria-hidden="true"></i> <span>Login</span>  <i class="fa fa-angle-down f-s-14" aria-hidden="true"></i>
                            </a>
                ...
                <div class="col-xl-6">
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5" style="background:#333;">
                              
	 						   
                                <center><h4 style="color: aliceblue;">NEON USER LOGIN</h4><br> <img src="images/j.png" height="300" width="500" alt=""></center> 
                                ...
                                <p class="mt-5 login-form__footer">Dont have account? <a href="signup.jsp" class="text-primary">Sign Up</a> now</p>
                            </div>
                        </div>
                    </div>
                </div>
