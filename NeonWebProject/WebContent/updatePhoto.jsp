						...
						<div class="card">
							...
							<h3>Update Photo Details</h3>
							   ...
							   <%
							    ...
							    PhotoServicesInterface audioServices = new PhotoServices();
								ArrayList<photos> arrayList = audioServices.getPhotoListToShare(photoID);
								...
								<div class="compose-content mt-5">
									...
									<form action="UpdatePhoto" method="post" enctype='multipart/form-data'>
										...
										<div class="form-group">
											<input type="text" name="photoID"  value="<%=photo.getPhotoID() %>" class="form-control " readonly>
										</div>
										
										Title
										<div class="form-group">
											<input type="text" name="title"  value="<%= photo.getName() %>" class="form-control bg-transparent">
										</div>
