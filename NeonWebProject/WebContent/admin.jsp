			...
			<div class="header-content clearfix">
				...
				<div class="header-right">
					<ul class="clearfix">
						...
						<li class="icons dropdown d-none d-md-flex"><a
							href="admin.jsp" class="log-user"><span style="color:#06575B; font-weight:bold;"><%=userName%></span>
						</a></li>
						...
						<li class="icons dropdown">
							<div class="user-img c-pointer position-relative"
								...
								<img src="images/${adm.fileName}" height="40" width="40" alt="">
								</c:forEach> --%>
                ...
                <div class="row">
                    <div class="col">
						...
						<%
							...
							if (path == null) {
						%>
            				<img src="./images/m.png" width="150px" height="150px" style="margin-left: 200px;margin-right: auto;">
            				<br>
            				<br>
            				<br>
							<br>
						...
						<%
								...
								for(Admin admin : adminDetails){
							%>
						    <img src="./images/<%=admin.getFileName() %>" width="150px" height="150px" style="margin-left: 200px;margin-right: auto;">
            				<br>
            				<br>
            				<br>
							<br>
            				...
            				<br>
							<br>
            				<h3>User Name:<%=admin.getEmail() %></h3>
            				<br>
							<br>
            				<h3>First Name:<%=admin.getFirstName()%></h3>
            				<br>
							<br>
              				<h3>Last Name:<%=admin.getLastName() %></h3>
              				<br>
							<br>
							<%}
							}%>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Asperiores repellendus molestiae exercitationem voluptatem tempora quo dolore nostrum dolor consequuntur itaque, alias fugit. Architecto rerum animi velit, beatae corrupti quos nam saepe asperiores aliquid quae culpa ea reiciendis ipsam numquam laborum aperiam. Id tempore consequuntur velit vitae corporis, aspernatur praesentium ratione!</p>
                                 <img src="./images/n.png" width="300px" height="200px" style="margin-left: 200px;margin-right: auto;">
                            <br>
                            <br>
                            <br>
                            	<h3>As the Administrator you can,</h3>
                            	<br>
                            	<br>
                            	<ul>
                            	  	<li>Add User</li>
                            	 	<li>Edit User</li>
                            	  	<li>Edit Content of Users</li>
                            		<li>Delete Content of Users</li>
                            	</ul>
