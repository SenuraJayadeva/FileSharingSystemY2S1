		...
		<div class="content-body">
			...
			<div class="container-fluid mt-3">
				<div class="row">
					...
					<div class="col-lg-6 col-sm-6">
						<a href="uploadPhoto.jsp">
							<div class="card section1 gradient-1">
								<div class="card-body">
									<h3 class="card-title text-white">Upload Image</h3>
									<div class="d-inline-block">
										<h2 class="text-white">Photoes</h2>
					...
					<div class="col-lg-6 col-sm-6">
						<a href="uploadAudio.jsp">
							<div class="card section1 gradient-3">
								<div class="card-body">
									<h3 class="card-title text-white">Upload Audio</h3>
									<div class="d-inline-block">
										<h2 class="text-white">Audio</h2>
										<p class="text-white mb-0">at maximum speed</p>
									</div>
									<span class="float-right display-5 opacity-5"><i
						...
						<a href="uploadVideo.jsp">
							<div class="card section1 gradient-4">
								<div class="card-body">
									<h3 class="card-title text-white">Upload Video</h3>
									<div class="d-inline-block">
