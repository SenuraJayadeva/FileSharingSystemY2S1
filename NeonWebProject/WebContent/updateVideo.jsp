								...
								<div class="compose-content mt-5">
									...
									<form action="UpdateVideo" method="post" enctype='multipart/form-data'>
										...
										<div class="form-group">
											<input type="text" name="videoID"  value="<%=video.getVideoID()%>" class="form-control " readonly>
										</div>
										
										Title
										<div class="form-group">
											<input type="text" name="title"  value="<%= video.getName() %>" class="form-control bg-transparent">
										</div>
