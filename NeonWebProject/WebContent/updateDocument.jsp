								...
								<div class="compose-content mt-5">
									...
									<form action="UpdateDocument" method="post" enctype='multipart/form-data'>
										...
										<div class="form-group">
											<input type="text" name="docID"  value="<%=doc.getDocId()%>" class="form-control " readonly>
										</div>
										
										Title
										<div class="form-group">
											<input type="text" name="title"  value="<%= doc.getName() %>" class="form-control bg-transparent">
										</div>
