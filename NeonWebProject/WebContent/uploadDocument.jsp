							...
							<div class="card-body">
								...
								<div class="compose-content mt-5">
									<form action="FileUploadServlet" method="post"
										...
										<div class="form-group">
											<textarea name="description" class="textarea_editor form-control bg-light"
												rows="15" placeholder="Description"></textarea>
										</div>
										<label for="docs">Choose a type:</label>
										<select id="docs">
									...
									<h5 class="m-b-20">
										<i class="fa fa-paperclip m-r-5 f-s-18"></i> Upload your document
									</h5>
									
										<div class="form-group">
											<div class="fallback">
												<input class="l-border-1"  name="file" id="file" type="file"
													multiple="multiple" onchange="selectType()">
											</div>
										</div>
									
								
								<div class="text-left m-t-15">
										<button class="btn btn-primary m-b-30 m-t-15 f-s-14 p-l-20 p-r-20 m-r-10" name="butn" id="butn" type="submit" ><i class="fa fa-paper-plane m-r-5"></i> Upload</button>
										
								
									<a href="uploadAudio.jsp"><button class="btn btn-dark m-b-30 m-t-15 f-s-14 p-l-20 p-r-20"
										type="button">
