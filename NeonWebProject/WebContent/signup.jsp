                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <form action="InsertCustomer" method="POST"   class="mt-5 mb-5 login-input" enctype='multipart/form-data'>
                                    ...
                                    <button id="submit"  onkeyup='check();' class="btn login-form__btn submit w-100" disabled>Sign in</button>

                                </form>
                                    <p class="mt-5 login-form__footer">Have account <a href="login.jsp" class="text-primary">Sign Up </a> now</p>
