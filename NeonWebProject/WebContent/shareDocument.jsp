...
<%@page import="com.neon.mainServices.DocumentServices"%>
<%@page import="com.neon.mainServices.DocumentServicesInterface"%>
					...
					<div class="col-lg-12">
						<div class="card">
							...
							<h3>Share File</h3>
					            ...
					            DocumentServicesInterface docServices = new DocumentServices();
								ArrayList<Document> arrayList = docServices.getDocumentDetails(docID);
								...
								<div class="compose-content mt-5">
									<form action="shareDocument" method="POST" enctype='multipart/form-data'>
									
										<div class="form-group">
											<input type="hidden" name="shareDocument_sendUser"  value="<%=userName%>" class="form-control bg-transparent">
										</div>
										
										<div class="form-group">
											<input type="hidden" name="shareDocument_sendUserImagePath"  value="<%=path%>" class="form-control bg-transparent">
										</div>
										
										<div class="form-group">
											<input type="hidden" name="shareDocument_docID" class="form-control bg-transparent"
												value="<%=doc.getDocId() %>">
										</div>
										
										<div class="form-group">
											<input type="text" name="shareDocument_name" class="form-control bg-transparent"
												value="<%=doc.getName() %>" readonly>
										</div>
											
										<div class="form-group">
											<input type="text" name="shareDocument_description" class="form-control bg-transparent"
												value="<%=doc.getDescription() %>" readonly>
										</div>
										
										<div class="form-group">
											<input type="text" name="shareDocument_filename" class="form-control bg-transparent"
												value="<%=doc.getFilename() %>" readonly>
										</div>
										
										<div class="form-group">
											<input type="hidden" name="shareDocument_path" class="form-control bg-transparent"
												value="<%=doc.getPath() %>">
										</div>
										
										<div class="form-group">
											<input type="text" name="shareDocument_receivedUser" class="form-control bg-transparent"
												placeholder = "Receive User" pattern = "[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}" required>
										</div>
