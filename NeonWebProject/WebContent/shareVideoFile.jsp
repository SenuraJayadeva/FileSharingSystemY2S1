...
<%@page import="com.neon.mainServices.VideoServicesInterface"%>
<%@page import="com.neon.mainServices.VideoServices"%>
						...
						<div class="card">
							...
							<h3>Share File</h3>
							   ...
							   <%
					            ...
					            VideoServicesInterface videoServices = new VideoServices();
								ArrayList<Video> arrayList = videoServices.getVideoDetails(videoID);
								...
								<div class="compose-content mt-5">
									<form action="shareVideo" method="post" enctype='multipart/form-data'>
									
										<div class="form-group">
											<input type="hidden" name="shareVideo_sendUser"  value="<%=userName%>" class="form-control bg-transparent">
										</div>
										
										<div class="form-group">
											<input type="hidden" name="shareVideo_sendUserImagePath"  value="<%=path%>" class="form-control bg-transparent">
										</div>
										
										<div class="form-group">
											<input type="hidden" name="shareVideo_audioID" class="form-control bg-transparent"
												value="<%=video.getVideoID()%>">
										</div>
										
										<div class="form-group">
											<input type="text" name="shareVideo_name" class="form-control bg-transparent"
												value="<%=video.getName() %>" readonly>
										</div>
											
										<div class="form-group">
											<input type="text" name="shareVideo_description" class="form-control bg-transparent"
												value="<%=video.getDescription() %>" readonly>
										</div>
										
										<div class="form-group">
											<input type="text" name="shareVideo_filename" class="form-control bg-transparent"
												value="<%=video.getFilename() %>" readonly>
										</div>
										
										<div class="form-group">
											<input type="hidden" name="shareVideo_path" class="form-control bg-transparent"
												value="<%=video.getPath() %>">
										</div>
										
										<div class="form-group">
											<input type="text" name="shareVideo_receivedUser" class="form-control bg-transparent"
