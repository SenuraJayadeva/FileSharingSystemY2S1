                                ...
                                <div class="basic-form">
                                    <form action="Contact_us" method="POST" >
                                        <div class="form-group">
                                            <input type="text" class="form-control input-flat" name="Name" placeholder="Name " required><br/>
                                            <input type="text" class="form-control input-flat" name="Email" placeholder="Email" pattern = "[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}" required><br/>
                                            <textarea class="form-control h-150px" rows="6" id="comment" name="Message" placeholder="Your message"></textarea><br/>
                                            <textarea class="form-control h-150px" rows="6" id="comment" name="Feedback" placeholder="Feedback"></textarea><br/>
                                        </div>
                                        <input type="submit" class = "button2" id="button2" name="button2"  value="Submit">
                                    </form>
                                </div>
                            </div>
                        </div>
