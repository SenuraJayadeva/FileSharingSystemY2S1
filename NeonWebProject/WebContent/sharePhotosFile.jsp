...
<%@page import="com.neon.mainServices.PhotoServicesInterface"%>
<%@page import="com.neon.mainServices.PhotoServices"%>
					...
					<div class="col-lg-12">
						<div class="card">
							...
							<h3>Share File</h3>
					            ...
					            PhotoServicesInterface photoServices = new PhotoServices();
								ArrayList<photos> arrayList = photoServices.getPhotoListToShare(photoID);
								
								for(photos pic : arrayList){
								%>
								...
								<div class="compose-content mt-5">
									<form action="sharePhotos" method="post" enctype='multipart/form-data'>
									
										<div class="form-group">
											<input type="hidden" name="sharePhotos_sendUser"  value="<%=userName%>" class="form-control bg-transparent">
										</div>
										
										<div class="form-group">
											<input type="hidden" name="sharePhotos_sendUserImagePath"  value="<%=path%>" class="form-control bg-transparent">
										</div>
										
										<div class="form-group">
											<input type="hidden" name="sharePhotos_photoID" class="form-control bg-transparent"
												value="<%=pic.getPhotoID() %>">
										</div>
										
										<div class="form-group">
											<input type="text" name="sharePhotos_name" class="form-control bg-transparent"
												value="<%=pic.getName() %>" readonly>
										</div>
											
										<div class="form-group">
											<input type="text" name="sharePhotos_description" class="form-control bg-transparent"
												value="<%=pic.getDescription() %>" readonly>
										</div>
										
										<div class="form-group">
											<input type="text" name="sharePhotos_filename" class="form-control bg-transparent"
												value="<%=pic.getFilename() %>" readonly>
										</div>
										
										<div class="form-group">
											<input type="hidden" name="sharePhotos_path" class="form-control bg-transparent"
												value="<%=pic.getPath() %>">
										</div>
										
										<div class="form-group">
											<input type="text" name="sharePhotos_receivedUser" class="form-control bg-transparent"
